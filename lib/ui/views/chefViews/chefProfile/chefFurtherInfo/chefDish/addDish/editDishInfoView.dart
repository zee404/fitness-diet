...
import 'package:fitness_diet/ui/views/chefViews/chefProfile/chefFurtherInfo/chefDish/addDish/editDishIngrView.dart';
...
class EditDishInfo extends StatefulWidget {
  Dish passedDish;
  EditDishInfo({@required this.passedDish});
  @override
  _EditDishInfoState createState() => _EditDishInfoState();
}

class _EditDishInfoState extends State<EditDishInfo> {
  String dishCatg;
...
// =====================================================================================
    screenList = [
      ...
      EditDishIngrView.withDishInfo(
        dishPic: dishPic != null ? dishPic : widget.passedDish.dishPic,
        dishName: dishNameContr != null && dishNameContr.text.isNotEmpty
            ? dishNameContr.text
            : widget.passedDish.dishName,
        dishPrice: priceContr != null && priceContr.text.isNotEmpty
            ? priceContr.text
            : widget.passedDish.dishPrice.toString(),
        totalPrepTime: totalPrepTime,
        dishCatg: dishCatg != null ? dishCatg :widget.passedDish.dishCatg,
        dishAttr: attrContr != null && attrContr.text.isNotEmpty
            ? attrContr.text
            : "",
        passedDish: widget.passedDish,
      ),
    ];
                      ...
                      child: Stack(
                        children: <Widget>[
                          dishPic != null
                              ...
                              : widget.passedDish.dishPic != null
                                  ? Container(
                                      child: Center(
                                        child: Image(
                                          image: NetworkImage(
                                            widget.passedDish.dishPic,
                                          ),
                                        ),
                                      ),
                                    )
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            TextFeildBigWhiteBG(
                ...
                isTypeInt: false,
                hintText:
                    'Current dish: ' + widget.passedDish.dishName.toString(),
                isObscureText: false),
            SizedBox(
